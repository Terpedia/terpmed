...
TERPENE_PLANT_GLYPHS = {
    ...
    "beta-pinene": ("🍐", "citrus peel / black pepper fruit"),
    "humulene": ("🍈", "hops / black pepper fruit"),
    "beta-caryophyllene": ("🌶️", "black pepper fruit"),
    "caryophyllene oxide": ("🫑", "clove / black pepper oxidation product"),
    "beta-myrcene": ("🥭", "mango"),
    "nerolidol": ("🍊", "orange blossom / citrus peel"),
    "linalool": ("🍇", "grape"),
    "terpinolene": ("🍎", "mango / juniper berry"),
    "phytol terpene": ("🥝", "chlorophyll-rich green plants"),
    "fenchol": ("🥒", "basil / fennel botanicals"),
    "borneol": ("🍑", "camphor tree / rosemary"),
    "terpineol": ("🍒", "tea tree / citrus flower"),
    "alpha-bisabolol": ("🍏", "chamomile"),
    "ocimene": ("🍌", "mango / grape"),
    "limonene": ("🍋", "lemon peel"),
    "1, 8, cineole": ("🫒", "eucalyptus / bay leaf"),
    "bornyl acetate": ("🍍", "pine / fir needles"),
    "p-cymene": ("🍅", "citrus peel / cumin / thyme"),
    "perillyl alcohol": ("🍓", "perilla / mint-family plants"),
    "sabinene": ("🥕", "black pepper fruit / carrot seed"),
    "alpha-terpinene": ("🥥", "tea tree / citrus peel"),
    "gamma-terpinene": ("🍉", "tea tree / citrus peel"),
    "r-carvone": ("🥑", "spearmint"),
